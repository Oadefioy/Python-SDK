...
def wave_back(arm):
    global waving_now
    if arm == "left":
        misty.change_led(128,0,128)
        # misty.play_audio("s_Acceptance.wav")
        misty.speak("Left", None, None, None, True, "tts-content")
        ...
        misty.change_led(121,0,121)
        misty.speak("Right", None, None, None, True, "tts-content")
...
def person_detection(data):
    if data["message"]["confidence"] >= 0.775:
